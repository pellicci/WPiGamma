...
# with command line options: --filein file:WPiGamma_pythia8_DIGIL1HLT_2018.root --fileout file:WPiGamma_pythia8_RECO_2018.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --era Run2_2018 --python_filename WPiGamma_13TeV_pythia8_RAW2DIGIRECO_2018_cfg.py --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:WPiGamma_pythia8_DIGIL1HLT_2018.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WPiGamma_pythia8_RECO_2018.root'),
