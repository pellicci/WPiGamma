...
# with command line options: --filein file:WPiGamma_pythia8_RECO_2017.root --fileout file:WPiGamma_pythia8_MINIAOD_2017.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v14 --step PAT --scenario pp --era Run2_2017,run2_miniAOD_94XFall17 --python_filename WPiGamma_13TeV_pythia8_MINIAOD_2017_cfg.py --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:WPiGamma_pythia8_RECO_2017.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WPiGamma_pythia8_MINIAOD_2017.root'),
