...
# with command line options: Pythia8CardFragment_plus.py --fileout file:WPiGamma_pythia8_GENSIM.root --pileup=2016_25ns_Moriond17MC_PoissonOOTPU --mc --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step GEN,SIM,DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:@frozen2016 --magField 38T_PostLS1 --datamix PreMix --era Run2_2016 --python_filename WPlusPiGamma_13TeV_pythia8_GENSIM_cfg.py --no_exec -n 2
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Pythia8CardFragment_plus.py nevts:2'),
