...
# with command line options: --filein file:WPiGamma_pythia8_GENSIM_2017.root --fileout file:WPiGamma_pythia8_DIGIL1HLT_2017.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-MCv2_correctPU_94X_mc2017_realistic_v9-v1/GEN-SIM-DIGI-RAW --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 94X_mc2017_realistic_v11 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:2e34v40 --datamix PreMix --era Run2_2017 --python_filename WPiGamma_13TeV_pythia8_DIGIL1HLT_2017_cfg.py --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:WPiGamma_pythia8_GENSIM_2017.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WPiGamma_pythia8_DIGIL1HLT_2017.root'),
...
from WPiGamma_MixingModule_2017 import MixingModule_list #List of files to open to get the correct mixing module (pile up)
