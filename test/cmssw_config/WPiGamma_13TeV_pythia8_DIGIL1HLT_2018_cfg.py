...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:WPiGamma_pythia8_GENSIM_2018.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WPiGamma_pythia8_DIGIL1HLT_2018.root'),
...
from WPiGamma_MixingModule_2018 import MixingModule_list #List of files to open to get the correct mixing module (pile up)
