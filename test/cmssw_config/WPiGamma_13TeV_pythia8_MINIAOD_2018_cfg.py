...
# with command line options: --filein file:WPiGamma_pythia8_RECO_2018.root --fileout file:WPiGamma_pythia8_MINIAOD_2018.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v15 --step PAT --geometry DB:Extended --era Run2_2018 --python_filename WPiGamma_13TeV_pythia8_MINIAOD_2018_cfg.py --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:WPiGamma_pythia8_RECO_2018.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:WPiGamma_pythia8_MINIAOD_2018.root'),
