...
mult_if_signal_mu_1.GetYaxis().SetRangeUser(1.,100000.)
mult_if_signal_mu_2.GetYaxis().SetRangeUser(1.,100000.)
mult_if_signal_mu_3.GetYaxis().SetRangeUser(1.,100000.)
...
mult_if_signal_el_1.GetYaxis().SetRangeUser(1.,100000.)
mult_if_signal_el_2.GetYaxis().SetRangeUser(1.,100000.)
mult_if_signal_el_3.GetYaxis().SetRangeUser(1.,100000.)
