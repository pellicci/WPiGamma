...
if runningEra == 1:
    config.General.requestName = 'WPlusPiGamma_Pythia8_GENSIM_94X_2017_v1'
    ...
    config.Data.outputPrimaryDataset = 'TTToSemilepWPlusPiGamma_GENSIM_94X_2017_v1'
...
if runningEra == 0:
    config.Data.outputDatasetTag = 'TTToSemilepWPlusPiGamma_GENSIM_80X_2016_v1'
if runningEra == 1:
    config.Data.outputDatasetTag = 'TTToSemilepWPlusPiGamma_GENSIM_94X_2017_v1'
if runningEra == 2:
    config.Data.outputDatasetTag = 'TTToSemilepWPlusPiGamma_GENSIM_102X_2018_v1'
