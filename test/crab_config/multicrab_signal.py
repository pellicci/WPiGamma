...
if runningEra == 0:
    config.General.workArea = 'crab_projects/samples_MC_2016_PythiaModeling/'
...
if runningEra == 1:
    config.General.workArea = 'crab_projects/samples_MC_2017_PythiaModeling/'
...
if runningEra == 2:
    config.General.workArea = 'crab_projects/samples_MC_2018_PythiaModeling/'
