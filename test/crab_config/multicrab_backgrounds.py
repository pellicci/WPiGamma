...
if __name__ == '__main__':
    ...
    if runningOn2017:
        ...
        config.General.requestName = 'WPiGammaAnalysis_ttbar_700to1000'
        config.Data.unitsPerJob = 5
        config.Data.inputDataset = '/TT_Mtt-700to1000_TuneCP5_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v2/MINIAODSIM'
        p = Process(target=submit, args=(config,))
        p.start()
        p.join()

        config.General.requestName = 'WPiGammaAnalysis_ttbar_1000toInf' # Quello senza PSweights non ha le condizioni di PU consigliate
        config.Data.unitsPerJob = 5
        config.Data.inputDataset = '/TT_Mtt-1000toInf_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM'
        p = Process(target=submit, args=(config,))
        p.start()
        p.join()
