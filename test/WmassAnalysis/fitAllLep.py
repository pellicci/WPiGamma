...
a2_mu = ROOT.RooRealVar("a2_mu","a2_mu",0.1,-5.,5.)
...
a2_el = ROOT.RooRealVar("a2_el","a2_el",0.1,-5.,5.)
...
Nbkg_el = ROOT.RooRealVar("Nbkg_el","Nbkg_el",150.,0.,1500.)
