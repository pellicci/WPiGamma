...
#First the muon
a0_mu = ROOT.RooRealVar("a0_mu","a0_mu",1.,-20.,20.)
a1_mu = ROOT.RooRealVar("a1_mu","a1_mu",0.,-20.,20.)
backPDF_mu = ROOT.RooChebychev("backPDF_mu","backPDF_mu",Wmass,ROOT.RooArgList(a0_mu,a1_mu))

#Then the electron
a0_el = ROOT.RooRealVar("a0_el","a0_el",1.,-20.,20.)
a1_el = ROOT.RooRealVar("a1_el","a1_el",0.,-20.,20.)
...
Nbkg_mu = ROOT.RooRealVar("Nbkg_mu","Nbkg_mu",700.,0.,1000.)
Nbkg_el = ROOT.RooRealVar("Nbkg_el","Nbkg_el",1000.,0.,2000.)
